...
const EstadoComedero = ({ value = 100 }) => {
  
  
  const clampedValue = Math.min(100, Math.max(0, value));

  return (
    <div className="flex flex-col items-center gap-2 bg-darkgrey">
      <div className="w-10 h-35 rounded-lg overflow-hidden relative border"
